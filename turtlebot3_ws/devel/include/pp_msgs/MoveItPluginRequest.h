...
struct MoveItPluginRequest_
{
  ...
  _joint_names_type joint_names;
   ...
   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _start_joint_type;
  _start_joint_type start_joint;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _goal_joint_type;
